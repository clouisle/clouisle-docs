    ...
    >
      <div className="flex flex-row items-center gap-2">
        <p className="text-sm font-medium pe-2">
          {isEnglish ? 'How is this guide?' : '这篇文章对你有帮助吗？'}
        </p>
        <button
      ...
      <CollapsibleContent className="mt-3">
        {previous ? (
          <div className="px-3 py-6 flex flex-col items-center gap-3 bg-fd-card text-fd-muted-foreground text-sm text-center rounded-xl">
            <p>{isEnglish ? 'Thank you for your feedback!' : '感谢你的反馈！'}</p>
            <div className="flex flex-row items-center gap-2">
              <a
              ...
              >
                {isEnglish ? 'View on GitHub' : '在 GitHub 上查看'}
              </a>
          ...
          <form className="flex flex-col gap-3" onSubmit={submit}>
            <textarea
              ...
              placeholder={isEnglish ? 'Leave your feedback...' : '写下你的反馈…'}
              onKeyDown={(e) => {
