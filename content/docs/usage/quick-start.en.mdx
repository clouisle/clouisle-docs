...
<figure>
  <img src="/images/quick-start-team-selection.png" alt="Selecting the current team" />
...
<figure>
  <img src="/images/quick-start-agent-editor.png" alt="Agent orchestration and preview" />
...
<Callout type="info" title="Image needed: first Agent conversation result">
  File: `/images/quick-start-chat-result.png`. Screenshot content: the chat page of a published Agent, containing one user message and one completed streaming reply, with the source or Token action bar highlighted. The screenshot must be cropped to the relevant area, with key actions outlined in the theme color. The future image's `alt` and caption both use "First Agent Conversation Result".
</Callout>
