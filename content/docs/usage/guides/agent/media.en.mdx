...
<Callout type="info" title="Image needed: Agent attachments and media capabilities">
  File: `/images/agent-media-capabilities.png`. Screenshot content: the Agent orchestration page showing the Files & Images, Image Generation, and Video Generation configuration cards in sequence, with each enable toggle and default model highlighted. Crop the screenshot to the relevant area and outline the key actions with the theme color. The future `alt` and caption for this image will both use "Agent attachments and media capabilities".
</Callout>
