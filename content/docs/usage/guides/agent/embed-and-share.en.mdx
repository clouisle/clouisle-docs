---
title: Agent Embed & Run View
description: Share published agents via dedicated run pages or embed them into external websites
icon: Share2
---
...
|---|---|---|
| **Allowed Domains** | Restrict widget loading to specific browser origins (`Origin` / `Referer` check) | `https://example.com, https://app.example.com` |
| **Widget Mode** | Choose between a floating launcher bubble or an inline embed | `Floating Bubble` or `Inline Iframe` |
| **Theme & Accent Color** | Customize the widget primary color to match your brand | `#2563eb` or auto light/dark matching |
