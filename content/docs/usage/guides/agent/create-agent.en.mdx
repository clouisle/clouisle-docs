...
<figure>
  <img src="/images/agent-settings-drawer.png" alt="Agent settings drawer" />
...
<Callout type="info" title="Image needed: Published Agent toolbar">
  File: `/images/agent-published-toolbar.png`. Screenshot content: the top of the Agent editor, highlighting the published status, public page, embed, settings, and save actions. Crop the screenshot to the relevant area and outline the key actions with the theme color. The future `alt` and caption for this image will both use "Published Agent toolbar".
</Callout>
