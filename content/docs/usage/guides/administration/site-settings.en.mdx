...
<Callout type="info" title="Image needed: Site settings navigation">
  File: `/images/site-settings-navigation.png`. Screenshot content: the complete left navigation of site settings with the General/Security/Notification channels/Storage/SSO tabs, highlighting the pages that require administrator permissions. Crop the screenshot to the relevant area and highlight key operations with theme-colored outlines. Future image `alt` and caption will both use “Site settings navigation”.
</Callout>
