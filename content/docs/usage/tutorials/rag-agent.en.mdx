...
<Callout type="info" title="Image needed: RAG Agent final result">
  File: `/images/tutorial-rag-agent-final.png`. Screenshot content: the RAG Agent conversation page showing the answer, source documents, and citation details, next to the retrieval lab quality validation results. Crop the screenshot to the relevant area and highlight key operations with theme-colored outlines. Future image `alt` and caption will both use “RAG Agent final result”.
</Callout>
...
<Callout type="info" title="Image needed: Document processing completed">
  File: `/images/tutorial-rag-document-ready.png`. Screenshot content: the target document in the knowledge base document list shows a completed status, with chunk count, Token count, and embedding progress. Crop the screenshot to the relevant area and highlight key operations with theme-colored outlines. Future image `alt` and caption will both use “Document processing completed”.
</Callout>
