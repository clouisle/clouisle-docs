...
An Agent has only two states: **Draft** and **Published**. Visibility is **Private** or **Team**. After publishing, the public conversation page, embeddable page, and API are available; publish permission and edit permission are controlled separately.
