...
| `rag_mode` | string | RAG mode: `off`, `auto`, `agentic` (default) |
| `variables` | array | Chat input variable definitions |
| `knowledge_bases` | array | Associated knowledge base configs (with `retrieval_top_k`, `score_threshold`, `search_mode`) |
