...
| GET | `/api/v1/agents/{agent_id}/stats/recent-conversations` | 查询最近会话 |
...
| 端点 | 说明 | 参数 |
| --- | --- | --- |
| `GET /agents/{agent_id}/stats/trends` | 趋势数据 | `period`: `24h`/`7d`/`30d` |
| `GET /agents/{agent_id}/stats/tool-usage` | 工具使用统计 | `period`: `24h`/`7d`/`30d`/`all` |
| `GET /agents/{agent_id}/stats/recent-conversations` | 最近会话 | `limit`: 默认 10 |
