...
<figure>
  <img src="https://rustfs-endpoint.yhnotes.com/content/agent-config-reference.png" alt="Agent config fields overview" />
  <figcaption>Agent config fields overview</figcaption>
</figure>
