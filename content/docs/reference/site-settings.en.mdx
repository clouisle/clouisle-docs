...
<Callout type="info" title="Image needed: Site settings fields overview">
  File: `/images/site-settings-reference.png`. Screenshot content: field groups of the site settings general, security, storage, and notification pages; the final material should be split into three images: theme, security, and channels. Crop the screenshots to the relevant areas and outline key actions with the theme color. Future image `alt` and caption will both use "Site settings fields overview".
</Callout>
