...
<Callout type="info" title="Image needed: Knowledge Base settings reference">
  File: `/images/knowledge-settings-reference.png`. Screenshot content: the Knowledge Base settings drawer, grouped into chunking, rerank, and retrieval; key fields should be outlined. Crop the screenshot to the relevant areas and outline key actions with the theme color. Future image `alt` and caption will both use "Knowledge Base settings reference".
</Callout>
