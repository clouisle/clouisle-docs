...
<Callout type="info" title="Image needed: source development service topology">
  File: `/images/source-development-topology.png`. Screenshot content: split terminal showing local development processes for frontend, api, worker/beat, and PostgreSQL/Redis/Qdrant; hide usernames and paths. Crop the screenshot to the relevant area and highlight key operations with theme-colored outlines. The future image's `alt` and caption both use "source development service topology".
</Callout>
