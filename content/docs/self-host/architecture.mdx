...
<Callout type="info" title="图片待补充：Clouisle 部署架构">
  文件：`/images/self-host-architecture.png`。截图内容：展示浏览器、外部反向代理、frontend、api、worker、sandbox-worker、beat 与 PostgreSQL/Redis/Qdrant 的请求和任务关系。截图需裁剪到相关区域，并用主题色框线标出关键操作。未来图片的 `alt` 与 caption 均使用“Clouisle 部署架构”。
</Callout>
